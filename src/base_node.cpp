            ...
            if(t==FRAME_TAIL){
              ...
              if(recv_data[9]==(recv_data[0]^recv_data[1]^recv_data[2]^recv_data[3]^recv_data[4]^recv_data[5]^recv_data[6]^recv_data[7]^recv_data[8])){
                ...
                */
                ...
                imu_data.angular_velocity.x = stGyroRawData.fZ;
                imu_data.angular_velocity.y = -stGyroRawData.fX;
                imu_data.angular_velocity.z = -stGyroRawData.fY;
                ...
                imu_data.linear_acceleration.x = stAccelRawData.fZ;
                imu_data.linear_acceleration.y = -stAccelRawData.fX;
                imu_data.linear_acceleration.z = -stAccelRawData.fY;
